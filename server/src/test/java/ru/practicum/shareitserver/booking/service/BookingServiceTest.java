...
public class BookingServiceTest {
    ...
    void create() {
        ...
        Assertions.assertEquals(bookingEntityWithId.getId(), result.getId());
    }
    ...
    void changeStatusNotOwner() {
        ...
        assertThrows(ValidationException.class, () -> service.changeStatus(booking.getId(), true, 100L));
    }
    ...
    void getBookingById() {
        ...
        assertNotNull(result);
        Assertions.assertEquals(bookingEntityWithId.getId(), result.getId());
        MatcherAssert.assertThat(bookingEntityWithId.getStart(), equalTo(result.getStart()));
        MatcherAssert.assertThat(bookingEntityWithId.getEnd(), equalTo(result.getEnd()));
        assertThat(bookingEntityWithId.getItem().getId(), equalTo(result.getItem().getId()));
        MatcherAssert.assertThat(bookingEntityWithId.getBooker().getId(), equalTo(result.getBooker().getId()));
        MatcherAssert.assertThat(bookingEntityWithId.getStatus(), equalTo(result.getStatus()));
    }
    ...
    void getBookingsByUserWithSize() {
        ...
        Assertions.assertEquals(bookingsList.get(0).getId(), result.get(0).getId());
    }
