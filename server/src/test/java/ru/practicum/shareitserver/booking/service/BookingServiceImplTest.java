...
public class BookingServiceImplTest {
    ...
    void create() {
        ...
        MatcherAssert.assertThat(entityCreated.getBooker().getId(), equalTo(booking.getBookerId()));
    ...
    void changeStatus() {
        ...
        MatcherAssert.assertThat(bookingCreated.getBooker().getId(), equalTo(bookingChanged.getBooker().getId()));
    ...
    void getBookingById() {
        ...
        MatcherAssert.assertThat(bookingCreated.getBooker().getId(), equalTo(bookingGetting.getBooker().getId()));
